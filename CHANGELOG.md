...
- **Index lock retry:** All Tantivy write operations now retry acquisition on lock contention; forced reindex no longer fails instantly. ([#41](https://github.com/rcrsr/rcrsr-codanna/pull/41), [#43](https://github.com/rcrsr/rcrsr-codanna/pull/43))
