...
- **Index lock retry:** Tantivy writer acquisition now retries on lock contention instead of failing on the first attempt. ([#41](https://github.com/rcrsr/rcrsr-codanna/pull/41))
